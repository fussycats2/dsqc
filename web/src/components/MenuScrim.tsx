...
//  · z-40: 헤더(z-30)·하단탭(z-20)·본문 위, Radix 메뉴 content(z-50) 아래.
...
export function MenuScrim({ show }: { show: boolean }) {
  ...
  return createPortal(
    <div className="pointer-events-none fixed inset-0 z-40 bg-black/25 backdrop-blur-[2px] animate-in fade-in-0 print:hidden" />,
    document.body,
  );
}
